(function(c){c.fn.ytVideos=function(b){return this.each(function(){$ytVideos=c(this);b=c.extend({rowSize:0,tooltips:!1,user:""},b);var f=$ytVideos.text().replace(/youtube (id|keyword):/i,""),a="?v=2&alt=jsonc&callback=?",a=0<b.user.length?"http://gdata.youtube.com/feeds/api/users/"+b.user+"/uploads"+a:"http://gdata.youtube.com/feeds/api/videos"+a;0<f.length&&(a+='&q="'+f+'"');0<b.count&&(a+="&max-results="+b.count);console.log(a);ytDone=!1;$ytVideos.empty();c.getJSON(a,function(a){if(0<a.data.totalItems){$ytVideos.append('<div class="ytPlayer"><div id="player" /></div>');
